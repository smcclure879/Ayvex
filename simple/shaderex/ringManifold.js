...
{	
	var mult=(!window.event.shiftKey)? 1 : 20;
...
function getMeshAroundMe(user)
{
	...
	for(var ii=0; ii<visualAcuity; ii++)
	{
		...
		var startDist=1.1;  //note can't be zero or less!
		var loopDelta = 50* startDist; //pi*2; //ha ha nothing to do with trig  but don't want an "even" number or even a rational!
		...
		//find a surface in that direction.
